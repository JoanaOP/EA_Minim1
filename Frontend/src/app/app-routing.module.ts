...
const routes: Routes = [
  ...
  { path: 'list-denuncias', component: ListDenunciasComponent},
  { path: 'create-denuncia', component: CreateDenunciaComponent},
  { path: 'edit-denuncia/:nameDenuncia', component: CreateDenunciaComponent},
